...
Checkout the latest releases on [maven central](https://search.maven.org/artifact/it.skrape/skrapeit) and just add the following to your build tool of choice to get the full feature set:
